...
class PluginExecutionService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      // TODO: UserAgent should effectively be configurable or come from settings
      const defaultUA =
          'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36';
      _requestChannel = NativeRequestChannel(
        _jsService!,
        defaultUserAgent: defaultUA,
        onLog: (msg) => debugPrint('[NET-LOG] $msg'),
      );
      ...
      debugPrint('[PluginExecutionService] Initialization Complete.');
