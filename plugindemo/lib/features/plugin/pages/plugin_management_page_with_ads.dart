...
import 'package:plugindemo/features/plugin/presentation/pages/plugin_test_page.dart';
...
import 'package:plugindemo/core/provider/providers/plugin_manager_service_provider.dart';
import 'package:plugindemo/features/common/widgets/generic_list_with_ads_page.dart'; // 注意：文件名保持不变，但使用GenericListPage
import 'package:plugindemo/generated/app_localizations.dart';

import 'package:plugindemo/features/plugin/presentation/pages/plugin_script_editor_page.dart';
import 'package:plugindemo/features/plugin/presentation/pages/plugin_url_webview_page.dart';
import 'package:plugindemo/features/plugin/presentation/pages/plugin_settings_dialog.dart';
import 'package:plugindemo/core/provider/providers/plugin_service_provider.dart';
...
class _PluginManagementPageWithAdsState
  ...
  Widget build(BuildContext context) {
    // 使用GenericListPage构建页面
    return GenericListPage<PluginEntry>(
