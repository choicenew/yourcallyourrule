...
Future<void> main() async {
  ...
  final String international =
      phoneUtil.format(phoneNumber1, PhoneNumberFormat.international);
  final String national =
      phoneUtil.format(phoneNumber1, PhoneNumberFormat.national);
  final String rfc3966 =
      phoneUtil.format(phoneNumber1, PhoneNumberFormat.rfc3966);
  ...
  final MatchType matchType =
      phoneUtil.isNumberMatch(phoneNumber1, phoneNumber2);
  ...
  final bool isValidRegionNumber =
      phoneUtil.isValidNumberForRegion(phoneNumber1, 'US');
  final AsYouTypeFormatter asYouTypeFormatter =
      phoneUtil.getAsYouTypeFormatter('GH');
  final Iterable<PhoneNumberMatch> foundPhoneNumbers =
      phoneUtil.findNumbers('Call me on 0201234567', 'GH');
  final String territory = await PhoneNumberOfflineGeocoder.instance
