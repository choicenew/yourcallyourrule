...
class FilterManagementWidget extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FilterManagementWidget> createState() =>
      _FilterManagementWidgetState();
}
...
class _FilterManagementWidgetState extends ConsumerState<FilterManagementWidget>
  ...
  Widget build(BuildContext context) {
    ...
    simCardsAsync.whenData((simCards) {
      ...
      if (simCount > 0 &&
          (_tabController == null || _tabController!.length != simCount)) {
  ...
  Widget _buildFilterContent() {
    ...
    return enhancedConfigAsync.when(
      data: (enhancedConfig) {
        final isSimSlotRuleEnabled =
            enhancedConfig.filterEnabledMap['SimSlotRuleService'] ?? false;
      ...
      error:
          (err, st) => Center(
            child: Text(
              AppLocalizations.of(context)!.dataLoadFailure(err.toString()),
            ),
          ),
    );
  }
                    ...
                    return Tab(
                      child: Column(
                        ...
                        children: [
                          Icon(
                            Icons.sim_card,
                            color: simSlot == 0 ? Colors.red : Colors.green,
                          ),
                          Text('SIM ${simSlot + 1}'),
                          Flexible(
                            child: Text(
  ...
  Widget _buildSimCardFilterRulesSwitch() {
    ...
    final config = ref.watch(
      enhancedFilterConfigProvider.select((asyncValue) => asyncValue.value),
    );
      ...
      builder: (context, ref, _) {
        ...
        return _buildFilterSwitchItem(
          ...
          onToggle: (value) {
            ...
            value
                ? notifier.enableFilter('SimSlotRuleService')
                : notifier.disableFilter('SimSlotRuleService');
          },
        );
      },
    );
  ...
  Widget _buildLocalCountFilterSwitch() {
    ...
    final config = ref.watch(
      localCountFilterConfigProvider.select((asyncValue) => asyncValue.value),
    );
    if (config == null) {
      return _buildFilterSwitchItem(
    ...
    return _buildFilterSwitchItem(
      ...
      onToggle:
          (value) => ref
              .read(localCountFilterConfigProvider.notifier)
              .updateConfig(config.copyWith(enableLocalCountFilter: value)),
    );
  }
  ...
  Widget _buildRemoteNumberFilterSwitch() {
    // [修正]: 使用 .select 只监听数据。
    final config = ref.watch(
      remoteNumberFilterConfigProvider.select((asyncValue) => asyncValue.value),
    );
    if (config == null) {
      return _buildFilterSwitchItem(
    ...
    return _buildFilterSwitchItem(
      ...
      onToggle:
          (value) => ref
              .read(remoteNumberFilterConfigProvider.notifier)
              .updateConfig(config.copyWith(enableRemoteNumberFilter: value)),
    );
  }
  ...
  Widget _buildTimeInterceptorSwitch() {
    // [修正]: 使用 .select 只监听数据。
    final config = ref.watch(
      timeInterceptorConfigProvider.select((asyncValue) => asyncValue.value),
    );
    if (config == null) {
      return _buildFilterSwitchItem(
    ...
    return _buildFilterSwitchItem(
      ...
      onToggle:
          (value) => ref
              .read(timeInterceptorConfigProvider.notifier)
              .updateShouldIntercept(value),
    );
  }
  ...
  Widget _buildCallFilterSwitch() {
    ...
    final enhancedConfig = ref.watch(
      enhancedFilterConfigProvider.select((v) => v.value),
    );
    ...
    if (callConfig == null || enhancedConfig == null) {
      ...
      return Container(
        padding: const EdgeInsets.all(16),
        decoration: BoxDecoration(
          color: const Color.fromARGB(255, 247, 32, 132).withOpacity(0.1),
          borderRadius: BorderRadius.circular(12),
        ),
        child: ListTile(
          title: Text(AppLocalizations.of(context)!.callFilterRules),
          subtitle: Text(
            AppLocalizations.of(context)!.callFilterRulesDescription,
          ),
      ...
      child: ExpansionTile(
        ...
        children: [
          SwitchListTile(
            ...
            subtitle: Text(
              AppLocalizations.of(context)!.enableCallFilterDescription,
            ),
            value: enhancedConfig.filterEnabledMap['CallFilterService'] ?? true,
            onChanged:
                (value) =>
                    value
                        ? enhancedNotifier.enableFilter('CallFilterService')
                        : enhancedNotifier.disableFilter('CallFilterService'),
          ),
          SwitchListTile(
            title: Text(AppLocalizations.of(context)!.rejectAllCalls),
            subtitle: Text(
              AppLocalizations.of(context)!.rejectAllCallsDescription,
            ),
            value: callConfig.rejectAllNumbers,
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(rejectAllNumbers: value),
                ),
          ),
          ...
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowAllAllowedNumbers: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowRegexAllowRules: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowBlockedNumbers: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowAllAllowRules: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowRegexBlockRules: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowAllBlockRules: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowSilenceRules: value),
                ),
          ),
          SwitchListTile(
            ...
            onChanged:
                (value) => callNotifier.updateConfig(
                  callConfig.copyWith(allowNoneRules: value),
                ),
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Switch(
            value:
                enhancedConfig.simSlotFilterConfigMap[simSlot]?[serviceId] ??
                enhancedConfig.filterEnabledMap[serviceId] ??
                true,
            onChanged: (value) {
              final notifier = ref.read(enhancedFilterConfigProvider.notifier);
              value
                  ? notifier.enableFilterForSimSlot(simSlot, serviceId)
                  : notifier.disableFilterForSimSlot(simSlot, serviceId);
            },
            activeColor: color,
          ),
        ],
