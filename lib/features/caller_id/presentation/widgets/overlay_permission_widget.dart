...
class OverlayPermissionWidget extends ConsumerStatefulWidget {
  const OverlayPermissionWidget({super.key});

  @override
  ConsumerState<OverlayPermissionWidget> createState() => _OverlayPermissionWidgetState();
}

class _OverlayPermissionWidgetState extends ConsumerState<OverlayPermissionWidget> {
  ...
  Future<void> _checkPermission() async {
    ...
    final hasPermission = await permissionService.hasOverlayPermission();
    if (mounted) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: SwitchListTile(
        title: Text(AppLocalizations.of(context)!.overlayPermission),
        subtitle: Text(AppLocalizations.of(context)!.overlayPermissionDescription),
