...
*/
  ...
  Future<void> _fetchCallLogs() async {
    ...
    PermissionStatus status =
        await Permission.phone.status; // 使用 Permission.phone.status 检查权限状态
    if (status.isGranted) {
...
*/
  ...
  */
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: List.generate(
                  ...
                  return SizedBox(
                    width: entryWidth,
                    child: FutureBuilder<CallerIdData>( // 将 FutureBuilder 移到这里
                      future: getCallerIdData(callLogEntry, context),
                      builder: (context, snapshot) {
                        ...
                        // 直接返回构建好的 Widget
                        return _buildCallLogItem(callerIdData, callLogEntry, entryWidth);  // 传递 CallerIdData
                      },
                    ),
                  );
                  }
  ...
  Widget _buildCallLogItem(CallerIdData callerIdData, CallLogEntry entry, double entryWidth) {
    return Card(
