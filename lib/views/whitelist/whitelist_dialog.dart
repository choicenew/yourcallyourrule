...
class SelectWhitelistEntriesDialog extends StatefulWidget {
  final List<WhitelistEntry> entries;

  const SelectWhitelistEntriesDialog({super.key, required this.entries});

  @override
  SelectWhitelistEntriesDialogState createState() =>
      SelectWhitelistEntriesDialogState();
}

class SelectWhitelistEntriesDialogState
    extends State<SelectWhitelistEntriesDialog> {
  final Set<WhitelistEntry> _selectedEntries = <WhitelistEntry>{};
  ...
  Widget _buildEntriesList(List<WhitelistEntry> entries) {
  ...
  Widget _buildSubscribed(List<WhitelistEntry> entries) {
    return ListView.separated(
      shrinkWrap: true,
      itemCount: entries.length,
      itemBuilder: (context, index) {
  ...
  Widget _buildUnsubscribed(List<WhitelistEntry> entries) {
    return ListView.separated(
      shrinkWrap: true,
      itemCount: entries.length,
      itemBuilder: (context, index) {
