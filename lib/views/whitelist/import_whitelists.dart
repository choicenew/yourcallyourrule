...
class ImportWhitelistsPageView extends StatelessWidget {
  const ImportWhitelistsPageView({super.key});
...
class ImportWhitelistsPage extends StatefulWidget {
  const ImportWhitelistsPage({super.key});

  @override
  ImportWhitelistsPageState createState() => ImportWhitelistsPageState();
}

class ImportWhitelistsPageState extends State<ImportWhitelistsPage> {
                ...
                alignment: Alignment.bottomRight,
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                          ...
                          // 导入号码
                          if (_urlController.text.isNotEmpty) {
                            _whitelistService.importNumbersFromUrl(_urlController.text);
                          } else if (filePath != null) {
                            _whitelistService.importNumbersFromLocal(filePath!);
                          } else {
                            showErrorSnackBar(
