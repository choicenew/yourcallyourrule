...
class SelectSmsBlacklistEntriesDialog extends StatefulWidget {
  final List<SmsBlacklistEntry> entries;

  const SelectSmsBlacklistEntriesDialog({super.key, required this.entries});

  @override
  SelectSmsBlacklistEntriesDialogState createState() =>
      SelectSmsBlacklistEntriesDialogState();
}

class SelectSmsBlacklistEntriesDialogState
    extends State<SelectSmsBlacklistEntriesDialog> {
  final Set<SmsBlacklistEntry> _selectedEntries = <SmsBlacklistEntry>{};
  ...
  Widget _buildEntriesList(List<SmsBlacklistEntry> entries) {
  ...
  Widget _buildSubscribed(List<SmsBlacklistEntry> entries) {
    return ListView.separated(
      shrinkWrap: true,
      itemCount: entries.length,
      itemBuilder: (context, index) {
  ...
  Widget _buildUnsubscribed(List<SmsBlacklistEntry> entries) {
    return ListView.separated(
      shrinkWrap: true,
      itemCount: entries.length,
      itemBuilder: (context, index) {
