...
class LabeledEntry extends ListEntry {
  LabeledEntry({
...
class LabelService extends ListService<LabeledEntry> {
  LabelService(Database database) : super(database, 'labeled_calls');

  @override
  LabeledEntry fromJson(Map<String, dynamic> json) =>
      LabeledEntry.fromJson(json);
