...
class CallChannelManager {
  ...
  void _setupShouldAcceptCallChannel() {
    shouldAcceptCallChannel.setMethodCallHandler((call) async {
      onShouldAcceptCallCall?.call(call);
      return null;
    });
  }
  ...
  Future<bool> shouldAcceptCall(String phoneNumber) async {
    return await shouldAcceptCallChannel.invokeMethod('shouldAcceptCall', phoneNumber);
  }

  Future<String> getInterceptAction() async {
    return await endCallChannel.invokeMethod('interceptAction');
  }
}