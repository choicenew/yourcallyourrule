...
class RemoteDatabaseManagerImpl implements RemoteDatabaseManager {
  ...
  // 注意：众包删除审核系统相关方法已移至 ProposalDataSource 类
  // 参见 lib/data/datasources/remote/proposal_datasource.dart
}