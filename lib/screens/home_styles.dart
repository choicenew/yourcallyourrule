...
class HomePaddingStyle {
  static const EdgeInsets paddingTop = EdgeInsets.only(left: 0, top: 0, right: 0, bottom: 30); 
  static const EdgeInsets searchBarPadding = EdgeInsets.only(left: 0, top: 0, right: 0, bottom: 30);
