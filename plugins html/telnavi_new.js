(function() {
    ...
    const manualMapping = {
         ...
         // Mappings from the telnaviKeywords_ja_JP list
    ...
    function getParsingScript(pluginId, phoneNumberToQuery) {
        return `
            (function() {
                ...
                const telnaviKeywords_ja_JP = ${JSON.stringify(telnaviKeywords_ja_JP)};
                ...
                function isValidPredefinedLabel(label) {
                 ...
                 function findMatchingKeyword_ja_JP(text) {
                     ...
                     for (const keyword of telnaviKeywords_ja_JP) {
