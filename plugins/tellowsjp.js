// tellowsjp.js - Refactored to match bd.js structure
(function() {
  ...
  const PLUGIN_CONFIG = {
      ...
      description: 'Queries tellows.jp for phone number information using an iframe proxy.', // Updated description
  };
  ...
  function initiateQuery(phoneNumber, requestId) {
      ...
      try {
          const targetSearchUrl = `https://www.tellows.jp/num/${encodeURIComponent(phoneNumber)}?lang=en`; // Updated URL
