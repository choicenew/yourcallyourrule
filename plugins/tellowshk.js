// tellowshk.js - Refactored to match bd.js structure
(function() {
  // --- Plugin Configuration ---
  const PLUGIN_CONFIG = {
      id: 'tellowshkPlugin', // Plugin ID, must be unique
      name: 'TellowsHK', // Plugin name
      version: '5.5.0', // Adjusted version to match bd.js structure versioning
      description: 'Queries hk.tellows.asia for phone number information using an iframe proxy.', // Updated description
  };
