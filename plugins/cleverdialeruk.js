// Cleverdialer UK Plugin - Iframe Proxy Solution
(function() {
  // --- Plugin Configuration ---
  const PLUGIN_CONFIG = {
      id: 'cleverdialerukPlugin',
      name: 'Cleverdialer UK',
      version: '5.5.0', // Adopted from bd.js
      description: 'Queries cleverdialer.co.uk for phone number information using an iframe proxy.'
  };
  ...
  const manualMapping = {
      ...
      'Debt Collection': 'Spam Likely',
      'Survey': 'Spam Likely',
      'Commercial': 'Spam Likely',
      'Harassment': 'Spam Likely',
      'Prank Call': 'Spam Likely',
      'Robocall': 'Spam Likely',
      'Unknown': 'Unknown',
      'Neutral': 'Unknown',
      'Positive': 'Other',
      'Trusted': 'Other',
      ...
      'Confirmation': 'Other',
      'Other': 'Other',
      // Spanish Keywords (from cleverdialer.es, if any overlap)
      'Estafa': 'Spam Likely',
      'Fraude': 'Spam Likely',
      'Molesto': 'Spam Likely',
   ...
   * Contains parsing logic for cleverdialer.co.uk
   */
