// Cleverdialer DE Plugin - Iframe Proxy Solution
(function() {
  ...
  const PLUGIN_CONFIG = {
      ...
      description: 'Queries cleverdialer.de for phone number information using an iframe proxy.'
  };
  ...
  const manualMapping = {
      ...
      'Betrugsversuch': 'Fraud Scam Likely',
      'Nicht Abnehmen': 'Spam Likely',
