// tellowstw.js - Refactored to match bd.js structure
(function() {
  // --- Plugin Configuration ---
  const PLUGIN_CONFIG = {
      id: 'tellowstwPlugin', // Plugin ID, must be unique
      name: 'TellowsTW', // Plugin name
      version: '5.5.0', // Adjusted version to match bd.js structure versioning
      description: 'Queries tellows.tw for phone number information using an iframe proxy.', // Updated description
  };
  ...
  function initiateQuery(phoneNumber, requestId) {
      ...
      try {
          const targetSearchUrl = `https://www.tellows.tw/num/${encodeURIComponent(phoneNumber)}?lang=en`; // Updated URL
